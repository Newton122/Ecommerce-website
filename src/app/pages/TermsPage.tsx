    ...
    <div className="bg-background min-h-screen pt-24 pb-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 text-white/70 text-sm leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
          <p>By using Blacphics, you agree to these terms. All content, designs, and artwork displayed on this site are the property of Blacphics and may not be reproduced without written permission.</p>
          <ul className="space-y-3 list-disc list-inside marker:text-primary">
            ...
            <li>Custom designs remain the intellectual property of Blacphics unless otherwise agreed in writing.</li>
